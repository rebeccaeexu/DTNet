    ...
    def forward(self, nbr_feat_l, ref_feat_l):
        ...
        for i in range(3, 0, -1):
            ...
            if i > 1:  # upsample offset and features
                ...
                _, _, h_o, w_o = offset.shape
                upsampled_offset = F.interpolate(offset, size=(h_o * 2, w_o * 2), mode='bilinear', align_corners=False)
                # upsampled_feat = self.upsample(feat)
                _, _, h_f, w_f = feat.shape
                upsampled_feat = F.interpolate(feat, size=(h_f * 2, w_f * 2), mode='bilinear', align_corners=False)
